...
#to reduce the randomness in text generation, top K sampling can be implemented to prevent the token with the highest probability getting chosen always
# brings in more variability in terms of text genration 
